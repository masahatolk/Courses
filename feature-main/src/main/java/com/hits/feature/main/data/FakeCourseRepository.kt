package com.hits.feature.main.data
...
class FakeCourseRepository : CourseRepository {
    ...
    override suspend fun getCourses(): List<CourseDomainModel> {
        return listOf(
            CourseDomainModel(
                id = 100,
            ...
            CourseDomainModel(
                ...
                text = "В этом уроке вы узнаете, кто такой аналитик данных и какие задачи он решяет. А главное — мы расскажем, чему вы научитесь по завершении программы обучения профессии «Аналитик данных».",
                price = "899",
                rate = "4.7",
